-- Phase 2A save_article_versioned runtime fix.
--
-- Fixes ambiguous wk_articles.draft_version references inside the
-- versioned save RPC by qualifying the updated table as article.
