-- Phase 7B V1: public Video read + caption delivery target authority.
-- Public Video reads resolve only the current immutable published version and
-- never expose private Media masters or caption storage paths.
...
revoke all on function public.get_public_video_index(integer) from public;
