...
export const EMAIL_BRIEFING_TEMPLATE_PROFILES: Record<string, BriefingTemplateProfile> = {
  culture_dispatch: { slug: "culture_dispatch", title: "Culture Dispatch", accentColor: "#5C8E25", family: "culture", editorialIntent: "card-led magazine routes, chart movement, artist attention, archive doors", headlinePattern: "A route through what culture left behind this week.", deckPattern: "Stories, charts, artists, archive routes and the wider creative record.", primaryModules: ["featured_routes", "chart_movement", "artist_attention", "archive_routes", "keep_going"] },
  ...
  registry_notes: { slug: "registry_notes", title: "Registry Notes", accentColor: "#6452C7", family: "registry", editorialIntent: "archive update cards, stats, audit routes", headlinePattern: "The archive changed. Here is what moved.", deckPattern: "New records, repaired credits, release shells, label links, and archive notes.", primaryModules: ["registry_stats", "archive_update_cards", "repair_notes", "admin_routes"] },
