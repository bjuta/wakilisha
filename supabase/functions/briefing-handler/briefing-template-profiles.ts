...
export const EMAIL_BRIEFING_TEMPLATE_PROFILES: Record<string, BriefingTemplateProfile> = {
  culture_dispatch: { slug: "culture_dispatch", title: "Culture Dispatch", accentColor: "#5C8E25", family: "culture", editorialIntent: "card-led magazine routes, chart movement, artist attention, archive entry points", headlinePattern: "A route through what culture left behind this week.", deckPattern: "Stories, charts, artists, archive routes, and the wider creative record.", primaryModules: ["featured_routes", "chart_movement", "artist_attention", "archive_routes", "keep_going"] },
  charts_digest: { slug: "charts_digest", title: "Charts Digest", accentColor: "#5C8E25", family: "charts", editorialIntent: "album-art chart leader, compact ranked artwork tiles, movement board", headlinePattern: "The chart has a story this week.", deckPattern: "A ranked read on songs moving, holding, re-entering, and gathering attention.", primaryModules: ["chart_lead", "ranked_artwork_tiles", "movement_board", "archive_chart_route"] },
  ...
  artist_signals: { slug: "artist_signals", title: "Artist Signals", accentColor: "#5C8E25", family: "artists", editorialIntent: "image-first artist wall, short artist notes, minimal metadata", headlinePattern: "Artists worth keeping close.", deckPattern: "Image-first artist notes, fresh attention, geography, and the next profile route.", primaryModules: ["artist_wall", "featured_artist", "artist_note_tiles", "related_routes"] },
  release_radar: { slug: "release_radar", title: "Release Radar", accentColor: "#A06800", family: "releases", editorialIntent: "cover-led release cards, new project grid, listen routes", headlinePattern: "New projects worth opening properly.", deckPattern: "Covers, release context, related artists, and the records creating new listening paths.", primaryModules: ["release_lead", "cover_grid", "chart_context", "artist_routes"] },
  new_voices: { slug: "new_voices", title: "New Voices", accentColor: "#9E3879", family: "artists", editorialIntent: "emerging artist wall, discovery framing, first reasons to listen", headlinePattern: "New names, early reasons to care.", deckPattern: "Emerging artists framed with image, geography, first routes, and next-listen context.", primaryModules: ["new_voice_wall", "spotlight_card", "first_listen_tiles", "discovery_routes"] },
  registry_notes: { slug: "registry_notes", title: "Archive Notes", accentColor: "#6452C7", family: "registry", editorialIntent: "archive update cards, stats, audit routes", headlinePattern: "The archive has new context.", deckPattern: "New records, repaired credits, release pages, label context, and archive notes.", primaryModules: ["registry_stats", "archive_update_cards", "repair_notes", "admin_routes"] },
  ...
  weekend_agenda: { slug: "weekend_agenda", title: "Weekend Agenda", accentColor: "#A06800", family: "agenda", editorialIntent: "Friday/Saturday/Sunday planner cards, live-culture routes", headlinePattern: "A cultural plan for the next few days.", deckPattern: "Events, listening, reading, places, and easy routes for the weekend.", primaryModules: ["agenda_hero", "day_cards", "listen_read_go", "save_routes"] },
  diaspora_signals: { slug: "diaspora_signals", title: "Diaspora Signals", accentColor: "#6452C7", family: "diaspora", editorialIntent: "home-distance-memory cards, diaspora artist routes", headlinePattern: "Distance is part of the record.", deckPattern: "Diaspora artists, home memory, language, taste moving across borders, and cross-border attention.", primaryModules: ["diaspora_lead", "distance_cards", "artist_routes", "memory_archive"] }
};
