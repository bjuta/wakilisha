// ── Public Content Read Gateway v15 — public API, no JWT required ──
// v15: Chart-entry fallback for tracks not yet in registry (slug normalization: spaces → hyphens)
