-- NON-AUTHORITATIVE K1 CANDIDATE.
--
-- Do not move this file into supabase/migrations until Phase 7A K0 Resource
-- Version Foundation has passed disposable-preview acceptance independently.
--
-- K1 changes the shared Resource lifecycle pointer authority from Article-only
-- version foreign keys to global Resource Version identity. Playlist and Audio
-- typed pointer columns remain synchronized compatibility mirrors during the
-- migration period.
