...
function baseScope(overrides: Partial<StoredChartMarketScope>): StoredChartMarketScope {
  ...
  return {
    ...
    artistOriginCountries: overrides.artistOriginCountries ?? [],
    artistOriginUnknownMode: overrides.artistOriginUnknownMode ?? "exclude",
...
export const DEFAULT_MARKET_SCOPES: StoredChartMarketScope[] = [
  baseScope({
    ...
    name: "Kenya",
    slug: "kenya",
    description: "Single-country Kenya market scope. Only artists with verified Kenyan origin qualify.",
    visibility: "public",
    primaryMarketSlug: "kenya",
    includedMarkets: [{ marketSlug: "kenya", countryCode: "KE" }],
    aggregationMode: "combined",
    artistOriginCountries: ["KE"],
    artistOriginUnknownMode: "exclude",
  }),
  baseScope({
    id: "scope_nigeria",
    name: "Nigeria",
    slug: "nigeria",
    description: "Single-country Nigeria market scope. Only artists with verified Nigerian origin qualify.",
    visibility: "public",
    primaryMarketSlug: "nigeria",
    includedMarkets: [{ marketSlug: "nigeria", countryCode: "NG" }],
    aggregationMode: "combined",
    artistOriginCountries: ["NG"],
    artistOriginUnknownMode: "exclude",
  }),
  baseScope({
