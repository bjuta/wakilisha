...
export const PROVIDER_CREDENTIAL_SCHEMAS: ProviderCredentialSchema[] = [
  ...
  },
  {
    id: "apple_music",
    title: "Apple Music",
    description: "Catalog metadata, chart rows, artwork, storefront lookup, and MusicKit preview tokens.",
    requiredEnvVars: ["APPLE_MUSIC_DEVELOPER_TOKEN", "APPLE_MUSIC_TEAM_ID", "APPLE_MUSIC_KEY_ID", "APPLE_MUSIC_PRIVATE_KEY"],
    optionalEnvVars: ["APPLE_MUSIC_SERVICE_ID", "APPLE_MUSIC_STOREFRONT"],
    fields: [
      { key: "developerToken", label: "Apple Music Developer Token", type: "secret", required: true, secret: true, envVar: "APPLE_MUSIC_DEVELOPER_TOKEN" },
      { key: "teamId", label: "Apple Team ID", type: "text", required: true, envVar: "APPLE_MUSIC_TEAM_ID" },
      { key: "keyId", label: "Apple Key ID", type: "text", required: true, envVar: "APPLE_MUSIC_KEY_ID" },
      { key: "privateKey", label: "Apple Private Key", type: "secretTextarea", required: true, secret: true, envVar: "APPLE_MUSIC_PRIVATE_KEY", helpText: "Paste the full key. Line breaks are preserved." },
    ...
    envTemplate: ["APPLE_MUSIC_DEVELOPER_TOKEN=", "APPLE_MUSIC_TEAM_ID=", "APPLE_MUSIC_KEY_ID=", "APPLE_MUSIC_PRIVATE_KEY=", "APPLE_MUSIC_SERVICE_ID=", "APPLE_MUSIC_STOREFRONT=ke"].join("\n"),
  },
  {
    id: "acrcloud",
    title: "ACRCloud",
