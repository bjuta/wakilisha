...
export const SETTINGS_DOMAINS: SettingsDomainMeta[] = [
  ...
  },
  {
    key: "audience",
    label: "Audience",
    description: "Redirects to Email & Briefings — subscriber management now lives in the briefing hub",
    icon: "Users",
    route: "/admin/settings/audience",
    health: "healthy",
    primaryAction: "Go to briefings",
  },
  {
    key: "emailBriefings",
    label: "Email & Briefings",
    description: "Briefing catalog, subscribers, issue generation & delivery, test sends — Supabase-backed newsletter infrastructure",
    icon: "Mail",
    route: "/admin/settings/email-briefings",
    health: "healthy",
    primaryAction: "Manage briefings",
  },
  {
    key: "maintenance",
    label: "Maintenance",
