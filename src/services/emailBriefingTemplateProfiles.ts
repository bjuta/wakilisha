...
export const EMAIL_BRIEFING_TEMPLATE_PROFILES: Record<BriefingTemplateSlug, BriefingTemplateProfile> = {
  culture_dispatch: {
    ...
    accentColor: "#5C8E25",
    family: "culture",
    editorialIntent: "card-led magazine routes, chart movement, artist attention, archive doors",
  ...
  artist_signals: {
    ...
    deckPattern: "Image-first artist notes, new attention, geography, and the next profile route.",
  ...
  registry_notes: {
    ...
    deckPattern: "New records, repaired credits, release shells, label links, and archive notes.",
