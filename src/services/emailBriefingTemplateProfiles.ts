...
const ARCHIVE_RULE = "Archive modules must explain why the old item matters now, not just list old links.";
...
export const EMAIL_BRIEFING_TEMPLATE_PROFILES: Record<BriefingTemplateSlug, BriefingTemplateProfile> = {
  culture_dispatch: {
    ...
    accentColor: "#5C8E25",
    family: "culture",
    editorialIntent: "card-led magazine routes, chart movement, artist attention, archive entry points",
    ...
    primaryModules: ["featured_routes", "chart_movement", "artist_attention", "archive_routes", "keep_going"],
  ...
  charts_digest: {
    ...
    headlinePattern: "The chart has a story this week.",
  ...
  artist_signals: {
    ...
    accentColor: "#5C8E25",
    family: "artists",
    editorialIntent: "image-first artist wall, short artist notes, minimal metadata",
    headlinePattern: "Artists worth keeping close.",
    deckPattern: "Image-first artist notes, fresh attention, geography, and the next profile route.",
    primaryModules: ["artist_wall", "featured_artist", "artist_note_tiles", "related_routes"],
    imageRule: IMAGE_RULE,
    archiveRule: ARCHIVE_RULE,
  },
  release_radar: {
    ...
    deckPattern: "Covers, release context, related artists, and the records creating new listening paths.",
  ...
  new_voices: {
    ...
    accentColor: "#9E3879",
    family: "artists",
    editorialIntent: "emerging artist wall, discovery framing, first reasons to listen",
    headlinePattern: "New names, early reasons to care.",
    deckPattern: "Emerging artists framed with image, geography, first routes, and next-listen context.",
    primaryModules: ["new_voice_wall", "spotlight_card", "first_listen_tiles", "discovery_routes"],
    imageRule: IMAGE_RULE,
    archiveRule: ARCHIVE_RULE,
  },
  registry_notes: {
    ...
    accentColor: "#6452C7",
    family: "registry",
    editorialIntent: "archive update cards, stats, audit routes",
    headlinePattern: "The archive has new context.",
    deckPattern: "New records, repaired credits, release pages, label context, and archive notes.",
    primaryModules: ["registry_stats", "archive_update_cards", "repair_notes", "admin_routes"],
    imageRule: IMAGE_RULE,
    archiveRule: ARCHIVE_RULE,
  },
  label_industry_notes: {
  ...
  weekend_agenda: {
    ...
    deckPattern: "Events, listening, reading, places, and easy routes for the weekend.",
  ...
  diaspora_signals: {
    ...
    deckPattern: "Diaspora artists, home memory, language, taste moving across borders, and cross-border attention.",
