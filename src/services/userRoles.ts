...
export type Capability =
  ...
  | "view_field_intake" | "view_restricted_field_sources"
...
const CAPABILITY_MATRIX: Record<UserRole, Capability[]> = {
  ...
  reviewer: ["view_dashboard", "view_audio", "view_video", "view_playlists", "view_review_queue", "manage_review_queue", "view_trust_records", "review_sources", "view_missing_images", "view_broken_links", "view_admin_readonly", "view_field_intake"],
