...
const CAPABILITY_MATRIX: Record<UserRole, Capability[]> = {
  administrator: ["view_dashboard", "view_audio", "edit_own_audio", "edit_others_audio", "publish_audio", "delete_audio", "view_playlists", "edit_own_playlists", "edit_others_playlists", "publish_playlists", "delete_playlists", "edit_own_articles", "edit_others_articles", "publish_articles", "delete_articles", "edit_guides", "edit_pages", "view_publishing_dashboard", "manage_publishing", "view_archive", "manage_categories", "manage_tags", "upload_media", "manage_media_library", "view_missing_images", "view_broken_links", "view_charts_admin", "manage_charts", "manage_ingest", "publish_charts", "view_registry", "manage_registry", "view_relationships", "manage_relationships", "view_review_queue", "manage_review_queue", "view_imports", "manage_imports", "view_settings", "manage_settings", "manage_integrations", "manage_appearance", "view_trust_records", "manage_sources", "review_sources", "withdraw_sources", "manage_citations", "manage_credits", "manage_users", "view_media_migration", "view_admin_readonly", ...SUBSCRIBER_CAPABILITIES, "comment_public", "moderate_community", "view_premium_content", "manage_subscription", "view_customer_orders", "manage_customer_orders", "submit_artist_claim", "manage_claimed_artist_profile", "submit_artist_media", "submit_label_updates", "view_partner_reports", "submit_chart_data", "view_research_exports", "export_research_data", "view_analytics", "view_support_console", "manage_support_cases", "view_developer_tools", "manage_developer_tools"],
  ...
  editor: ["view_dashboard", "view_audio", "edit_own_audio", "edit_others_audio", "publish_audio", "delete_audio", "view_playlists", "edit_own_playlists", "edit_others_playlists", "publish_playlists", "delete_playlists", "edit_own_articles", "edit_others_articles", "publish_articles", "delete_articles", "edit_guides", "edit_pages", "view_publishing_dashboard", "manage_publishing", "view_archive", "manage_categories", "manage_tags", "upload_media", "manage_media_library", "view_missing_images", "view_broken_links", "view_review_queue", "manage_review_queue", "view_trust_records", "manage_sources", "manage_citations", "manage_credits", "view_media_migration", "view_admin_readonly"],
  ...
  reviewer: ["view_dashboard", "view_audio", "view_playlists", "view_review_queue", "manage_review_queue", "view_trust_records", "review_sources", "view_missing_images", "view_broken_links", "view_admin_readonly"],
  ...
  author: ["view_dashboard", "view_audio", "edit_own_audio", "edit_own_playlists", "edit_own_articles", "publish_articles", "upload_media", "manage_media_library", "view_admin_readonly"],
  analyst: ["view_dashboard", "view_analytics", "view_charts_admin", "view_registry", "view_review_queue", "view_admin_readonly"],
  writer: ["view_audio", "edit_own_audio", "edit_own_playlists", "edit_own_articles", "upload_media", "manage_media_library"],
