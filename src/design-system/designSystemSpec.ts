...
export const wakilishaDesignSystemSpec: WkDesignSystemSpec = {
  ...
  parityPageMap: [
    ...
    { route: '/releases/:artistSlug/:releaseSlug', archetype: 'Single release', chapters: ['22','35','41','42','45','53'], qaChecks: ['22-relationships-visible','22-graph-backed','22-slug-routes','35-scale-appropriate','41-tracklist-accurate','41-modal-consistent','41-no-flatten','42-focus-trap','42-reduced-motion','42-same-language','45-specific-copy','45-og-preview','45-timestamp','53-hit-area'] },
