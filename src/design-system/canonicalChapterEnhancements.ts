import type { WkCanonicalChapterEnhancement } from '@/design-system/designSystemSpecTypes';

const chapterGroups: Record<string, WkCanonicalChapterEnhancement['group']> = {
  '01': 'Foundations', '02': 'Foundations', '03': 'Foundations', '04': 'Foundations', '05': 'Foundations',
  '06': 'Foundations', '07': 'Foundations', '08': 'Foundations', '09': 'Foundations',
  '10': 'Product', '11': 'Product', '12': 'Product', '13': 'Product', '14': 'Product',
  '15': 'Product', '16': 'Product', '17': 'Product', '18': 'Product',
  ...
  '35': 'React App UI', '36': 'React App UI', '37': 'React App UI', '38': 'React App UI', '39': 'React App UI',
  '40': 'React App UI', '41': 'React App UI', '42': 'React App UI', '43': 'React App UI', '44': 'React App UI',
  '45': 'React App UI', '46': 'React App UI', '47': 'React App UI', '48': 'React App UI', '49': 'React App UI',
  '50': 'React App UI', '51': 'React App UI', '52': 'React App UI', '53': 'React App UI', '54': 'React App UI',
};

const chapterTitles: Record<string, string> = {
  '01': 'North Star', '02': 'Brand architecture', '03': 'Logo', '04': 'Color', '05': 'Typography',
  '06': 'Spacing & layout', '07': 'Motion', '08': 'Voice', '09': 'Accessibility',
  '10': 'Navigation', '11': 'Buttons & actions', '12': 'Forms', '13': 'Cards & surfaces',
  '14': 'Tags & badges', '15': 'Track & entity rows', '16': 'Player system', '17': 'Search & discovery', '18': 'States',
  '19': 'Image system', '20': 'Editorial articles', '21': 'Charts & rankings', '22': 'Registry', '23': 'Page archetypes',
  '24': 'Social templates', '25': 'Commercial surfaces', '26': 'Cultural verticals', '27': 'Internationalization', '28': 'Rights & attribution',
  '29': 'Tokens', '30': 'Component inventory', '31': 'Figma organization', '32': 'QA checklist', '33': 'Anti-slop rules',
  '34': 'Roadmap', '35': 'Hero sections', '36': 'Genre directory', '37': 'Artist directory', '38': 'Magazine page',
  '39': 'Charts edition', '40': 'Single track', '41': 'Single album', '42': 'Album modal', '43': 'Labels directory',
  '44': 'Article / post', '45': 'Sharing system', '46': 'Iconography', '47': 'Dark / light mode', '48': 'User profile',
  '49': 'Settings pages', '50': 'Admin areas', '51': 'Notifications', '52': 'Modals & overlays', '53': 'Mobile patterns',
  '54': 'Delight & animation',
};
...
const canonicalMetrics: Record<string, Omit<WkCanonicalChapterEnhancement['canonicalMetrics'], 'visualSpecimens'>> = {
  '01': { subsections: 1, tables: 0, codeBlocks: 0, callouts: 1, doDontCards: 0 },
  '02': { subsections: 2, tables: 1, codeBlocks: 0, callouts: 1, doDontCards: 0 },
  '03': { subsections: 6, tables: 0, codeBlocks: 0, callouts: 1, doDontCards: 2 },
  '04': { subsections: 5, tables: 1, codeBlocks: 0, callouts: 1, doDontCards: 2 },
  '05': { subsections: 6, tables: 2, codeBlocks: 3, callouts: 1, doDontCards: 0 },
  '06': { subsections: 5, tables: 5, codeBlocks: 0, callouts: 1, doDontCards: 0 },
  '07': { subsections: 4, tables: 2, codeBlocks: 0, callouts: 1, doDontCards: 0 },
  '08': { subsections: 3, tables: 2, codeBlocks: 0, callouts: 1, doDontCards: 6 },
  '09': { subsections: 3, tables: 2, codeBlocks: 0, callouts: 0, doDontCards: 0 },
};
...
export const canonicalChapterEnhancementByNumber = Object.fromEntries(
  canonicalChapterEnhancements.map((chapter) => [chapter.number, chapter])
) as Record<string, WkCanonicalChapterEnhancement>;

export const canonicalChapterEnhancementByAnchor = Object.fromEntries(
  canonicalChapterEnhancements.map((chapter) => [chapter.canonicalAnchor, chapter])
) as Record<string, WkCanonicalChapterEnhancement>;