...
const routes: RouteObject[] = [
  ...
  { path: "/start", element: <RegistryOnboardingPage /> },
  {
    ...
    children: [
      ...
      { path: "/shows", element: <ResponsivePage mobile={<PublicShowsPage />} desktop={<PublicShowsPage />} /> },
      ...
      { path: "/video", element: <ResponsivePage mobile={<PublicVideoPage />} desktop={<PublicVideoPage />} /> },
      { path: "/video/:slug", element: <ResponsivePage mobile={<PublicVideoDetailPage />} desktop={<PublicVideoDetailPage />} /> },
  ...
  },
  {
    ...
    children: [
      ...
      { path: "field", element: <AdminGuard capabilities={["view_field_intake"]}><AdminFieldPage /></AdminGuard> },
