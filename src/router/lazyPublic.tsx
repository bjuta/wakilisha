...
export const PublicAudioPage = lazy(
  () => import("../pages/audio/page"),
);

export const PublicAudioDetailPage = lazy(
  () => import("../pages/audio/detail/page"),
);

export const PublicVideoPage = lazy(
  () => import("../pages/video/page"),
);

export const PublicVideoDetailPage = lazy(
...
export const PublicShowEpisodePage = lazy(
  () => import("../pages/shows/episode/page"),
);
...
export const PostDetailPage = lazy(
  () => import("../pages/posts/detail/page"),
);
