...
const fieldArtistsContinued = [
  ...
  { tag: "KENYA", name: "Wangechi Mutu", origin: "Kenya | New York and Nairobi", image: "https://wakilisha.africa/wp-content/plugins/wakilisha-v2.0.201-cpt-cleanup/images/guides/in-minor-keys/p17-img1.webp", description: "Plants and insect homes wild the Central Pavilion." },
  { tag: "KENYA", name: "Kaloki Nyamai", origin: "Kenya | Nairobi", image: "https://wakilisha.africa/wp-content/plugins/wakilisha-v2.0.201-cpt-cleanup/images/guides/in-minor-keys/p17-img2.webp", description: "Sisal rope embedded in painting and Kenyan material memory." },
  ...
  { tag: "SCHOOL", name: "NCAI", origin: "Kenya | School", image: "https://wakilisha.africa/wp-content/plugins/wakilisha-v2.0.201-cpt-cleanup/images/guides/in-minor-keys/p17-img3.webp", description: "East African art collection and institutional voice." },
