export const readingGuide = {
  ...
  lede: `"Books moved through our lives in ways that were informal, improvised, and occasionally rebellious. No one called this a reading culture. It was daily life."`,
  author: {
    name: "Wangari Karume",
  ...
  toc: [
    ...
    { id: "home-ecosystem", label: "The Home Reading World", num: "II" },
...
export const prologueChapter = {
  ...
  paragraphs: [
    ...
    {
      html: `Looking back now, what strikes me is not the individual titles but the strange and vibrant reading world through which they circulated. Books moved through our lives in ways that were informal, improvised, and occasionally rebellious. Teachers lent them. Friends smuggled them into classrooms. Parents stacked them on shelves at home. Someone’s older sibling passed one along. A cousin left another behind during a visit.`,
    },
  ],
  pullQuote: `No one called this a "reading culture." It was daily life.`,
};
...
export const classroomLibrary = {
  ...
  paragraphs: [
    ...
    {
      html: `He would read some random line from the book then run to you and demand, "Fafanua mukhtadha wa dondoo hili." You did not just claim to have read the book. You demonstrated it.`,
    },
    {
...
export const homeEcosystem = {
  ...
  paragraphsAfter: [
    ...
    {
      html: `Girls brought books from home and shared them in ways that now feel almost ingenious. Thick novels by writers like Nora Roberts and Dan Brown would be physically divided into three sections. The first third went to one reader, the middle to another, the final section to a third. Once someone finished their portion, the sections rotated.`,
    },
  ],
  pullQuote: `It was a crude but ruthlessly efficient literary supply chain.`,
  paragraphsAfterPull: [
    {
      html: `At the time it felt normal. Only later did I realize how unusual it was. Formal reading infrastructure like school libraries, public libraries, and curated literary spaces barely existed in our daily lives. Yet the books themselves circulated relentlessly through informal networks.`,
    },
    {
    ...
    {
      html: `Research on reading behavior consistently identifies access to books as the clearest predictor of sustained reading habits. When books are present in homes, classrooms, and communities, and when they circulate visibly and frequently, children read more.`,
    },
    {
...
export const readingInfrastructure = {
  ...
  paragraphs: [
    {
      html: `My childhood was not defined by formal reading infrastructure. It was defined by living, breathing reading worlds.`,
    },
  ],
  listBurst: [
  ...
  paragraphsAfter: [
    ...
    {
      html: `It was <em>habitus</em> at work: a system of durable dispositions quietly shaped by repeated social experiences. Family expectations, classroom practices, and peer networks all converged to produce a child for whom reading felt ordinary.`,
    },
    {
...
export const largerQuestion = {
  ...
  paragraphs: [
    ...
    {
      html: `The question is not merely personal. Across the world, educators, librarians, and researchers have begun to ask similar questions. Why do children who read enthusiastically gradually abandon the habit? My childhood suggests something intriguing. Readers were not produced solely by institutions. They emerged from networks, from the overlapping efforts of teachers, parents, peers, and communities that placed books into circulation. What happens when the networks that once sustained reading begin to fracture? And what replaces them?`,
    },
    {
      html: `If those networks weaken, what happens to the reader?`,
    },
    {
    ...
    {
      html: `To answer those questions, we must first return to a time when reading felt inevitable. A time when the page still held the center of gravity in our intellectual lives. A time when the infrastructures of reading, from libraries and classrooms to bookstores and homes, formed the backbone of a cultural world that made books unavoidable.`,
    },
    {
