export const inMinorKeysData = {
  ...
  heroImage: "https://wakilisha.africa/wp-content/plugins/wakilisha-v2.0.201-cpt-cleanup/images/guides/in-minor-keys/p21-img1.webp",
  ...
  preview: {
    ...
    label: "24 pages",
    cards: [
      { number: "01", label: "The Curator", title: "Koyo Kouoh", description: "The vision, structure and moral intelligence behind In Minor Keys.", image: "https://wakilisha.africa/wp-content/plugins/wakilisha-v2.0.201-cpt-cleanup/images/guides/in-minor-keys/p05-img1.webp", size: "large" as const },
      { number: "02", label: "Main Exhibition", title: "African and diaspora artists", description: "First routes into the artists, materials and questions.", image: "https://wakilisha.africa/wp-content/plugins/wakilisha-v2.0.201-cpt-cleanup/images/guides/in-minor-keys/p07-img1.webp" },
      { number: "03", label: "Pavilions", title: "13 African nations", description: "Country, curator, artists, venue and first reason to pay attention.", image: "https://wakilisha.africa/wp-content/plugins/wakilisha-v2.0.201-cpt-cleanup/images/guides/in-minor-keys/p15-img1.webp" },
      { number: "04", label: "Kenya", title: "No pavilion. Serious presence.", description: "Wangechi Mutu, Kaloki Nyamai and NCAI.", image: "https://wakilisha.africa/wp-content/plugins/wakilisha-v2.0.201-cpt-cleanup/images/guides/in-minor-keys/p16-img1.webp" },
      { number: "05", label: "Schools / Route / Undercurrents", title: "Schools, routes and undercurrents", description: "Institutions, oases, procession and slow looking beneath the main map.", image: "https://wakilisha.africa/wp-content/plugins/wakilisha-v2.0.201-cpt-cleanup/images/guides/in-minor-keys/p17-img3.webp" },
      { number: "06", label: "Practical info", title: "Dates, tickets and routes", description: "Start here before planning your route.", image: "https://wakilisha.africa/wp-content/plugins/wakilisha-v2.0.201-cpt-cleanup/images/guides/in-minor-keys/p21-img1.webp" },
    ],
  },
  curator: {
    ...
    title: "Koyo",
    titleItalic: "Kouoh",
    image: "https://wakilisha.africa/wp-content/plugins/wakilisha-v2.0.201-cpt-cleanup/images/guides/in-minor-keys/p19-img1.webp",
    bio: "Kouoh had already shaped the theoretical framework, artist list, catalogue authors, graphic idrecord and exhibition architecture before her death in May 2025. That makes In Minor Keys less a posthumous tribute than a final transmission carried forward by her chosen team.",
    timeline: [
  ...
  focus: {
    ...
    cards: [
      { number: "01", label: "Living architecture", title: "Wangechi Mutu", description: "Plants and insect homes gradually wild the Central Pavilion facade.", image: "https://wakilisha.africa/wp-content/plugins/wakilisha-v2.0.201-cpt-cleanup/images/guides/in-minor-keys/p17-img1.webp" },
      { number: "02", label: "Sisal as history", title: "Kaloki Nyamai", description: "Sisal enters painting as Kenyan material memory and place.", image: "https://wakilisha.africa/wp-content/plugins/wakilisha-v2.0.201-cpt-cleanup/images/guides/in-minor-keys/p17-img2.webp" },
      { number: "03", label: "Institutional voice", title: "NCAI", description: "Nairobi appears as one of the Schools, not as an afterthought.", image: "https://wakilisha.africa/wp-content/plugins/wakilisha-v2.0.201-cpt-cleanup/images/guides/in-minor-keys/p17-img3.webp" },
    ],
  ...
  sample: {
    ...
    pages: [
      { image: "https://wakilisha.africa/wp-content/plugins/wakilisha-v2.0.201-cpt-cleanup/images/guides/in-minor-keys/sample-pages/page-01.webp", alt: "Sample page 1" },
      { image: "https://wakilisha.africa/wp-content/plugins/wakilisha-v2.0.201-cpt-cleanup/images/guides/in-minor-keys/sample-pages/page-02.webp", alt: "Sample page 2" },
      { image: "https://wakilisha.africa/wp-content/plugins/wakilisha-v2.0.201-cpt-cleanup/images/guides/in-minor-keys/sample-pages/page-03.webp", alt: "Sample page 3" },
      { image: "https://wakilisha.africa/wp-content/plugins/wakilisha-v2.0.201-cpt-cleanup/images/guides/in-minor-keys/sample-pages/page-05.webp", alt: "Sample page 4" },
      { image: "https://wakilisha.africa/wp-content/plugins/wakilisha-v2.0.201-cpt-cleanup/images/guides/in-minor-keys/sample-pages/page-09.webp", alt: "Sample page 5" },
      { image: "https://wakilisha.africa/wp-content/plugins/wakilisha-v2.0.201-cpt-cleanup/images/guides/in-minor-keys/sample-pages/page-13.webp", alt: "Sample page 6" },
      { image: "https://wakilisha.africa/wp-content/plugins/wakilisha-v2.0.201-cpt-cleanup/images/guides/in-minor-keys/sample-pages/page-17.webp", alt: "Sample page 7" },
      { image: "https://wakilisha.africa/wp-content/plugins/wakilisha-v2.0.201-cpt-cleanup/images/guides/in-minor-keys/sample-pages/page-21.webp", alt: "Sample page 8" },
      { image: "https://wakilisha.africa/wp-content/plugins/wakilisha-v2.0.201-cpt-cleanup/images/guides/in-minor-keys/sample-pages/page-22.webp", alt: "Sample page 9" },
      { image: "https://wakilisha.africa/wp-content/plugins/wakilisha-v2.0.201-cpt-cleanup/images/guides/in-minor-keys/sample-pages/page-23.webp", alt: "Sample page 10" },
    ],
  },
  download: {
    eyebrow: "Free PDF",
