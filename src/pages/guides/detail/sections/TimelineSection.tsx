import type { TimelineData } from "../sectionTypes";
      ...
      <div className="wk-container-wide px-6 md:px-10 lg:px-16">
        ...
        <ol className="relative space-y-0">
          ...
          {data.events.map((evt, index) => (
            <li key={index} className="relative flex items-start gap-4 md:gap-6 pb-8 last:pb-0">
              ...
              <div className="flex-1 min-w-0 pt-1">
                <time className="block text-xs font-bold uppercase tracking-wider text-[var(--wk-v-fashion)] mb-1">{evt.date}</time>
