...
/* ── Compact story card matching magazine page's CompactCardFill rhythm ── */
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden" style={{ background: "var(--wk-bg)" }}>
      ...
      <div className="relative z-[1]">
        ...
        {/* ── 6. Error banner ── */}
        {loadError && (
          <div className="border-b border-[var(--wk-danger)]/20 bg-[var(--wk-danger-soft)] px-6 py-3">
        ...
        <section className="py-16 md:py-24 border-t border-[var(--wk-divider)]" style={{ background: "var(--wk-bg)" }}>
          <div style={{ maxWidth: 1180, margin: "0 auto", padding: "0 clamp(20px,4vw,40px)" }}>
            ...
            <div className="flex items-end justify-between gap-5 flex-wrap mb-10 md:mb-14">
              <div>
                ...
                <h2 className="font-black tracking-[-0.04em] text-[var(--wk-text)]" style={{ fontSize: "clamp(28px,3.5vw,48px)", lineHeight: 0.92 }}>
                  Editorial
                </h2>
              </div>
            ...
            {loading ? (
              <div className="grid gap-4 lg:grid-cols-5 lg:items-stretch">
                ...
                <div className="lg:col-span-2 grid grid-cols-1 gap-4" style={{ gridTemplateRows: "repeat(3, 1fr)" }}>
                  <div className="animate-pulse rounded-xl border border-[var(--wk-border)] bg-[var(--wk-surface)]" />
                  <div className="animate-pulse rounded-xl border border-[var(--wk-border)] bg-[var(--wk-surface)]" />
                  <div className="animate-pulse rounded-xl border border-[var(--wk-border)] bg-[var(--wk-surface)]" />
                </div>
              </div>
        ...
        <section className="py-16 md:py-24 border-t border-[var(--wk-divider)]" style={{ background: "var(--wk-bg-subtle)" }}>
          <div style={{ maxWidth: 1180, margin: "0 auto", padding: "0 clamp(20px,4vw,40px)" }}>
            ...
            >
              ...
              <div
                aria-hidden="true"
                className="pointer-events-none absolute -bottom-20 -left-20 w-[350px] h-[350px] rounded-full opacity-[0.04]"
              ...
              <div className="relative z-10 p-8 md:p-12 max-w-[600px]">
                ...
                <h2 className="font-black tracking-[-0.03em] text-[var(--wk-text)] mb-3" style={{ fontSize: "clamp(22px,2.5vw,32px)", lineHeight: 1.0 }}>
