...
export function ArticleRelated({ stories, loading }: ArticleRelatedProps) {
  if (loading) {
    return (
          ...
          {primary && (
            ...
            >
              ...
              <div className="p-6 flex-1 flex flex-col gap-3">
                <h3 className="text-[20px] font-black tracking-[-0.03em] leading-snug text-[var(--wk-text)] group-hover:text-[var(--wk-brand)] transition-colors line-clamp-2">
                  {primary.title}
                </h3>
                {primary.dek && (
                  <p className="text-[14px] leading-relaxed text-[var(--wk-text-muted)] line-clamp-2">
                    {primary.dek}
                  </p>
                )}
            ...
            {rest.slice(0, 2).map((story) => (
              ...
              >
                ...
                <div className="flex flex-col gap-1.5 min-w-0 flex-1">
                  ...
                  <h4 className="text-[16px] font-bold tracking-[-0.02em] leading-snug text-[var(--wk-text)] group-hover:text-[var(--wk-brand)] transition-colors line-clamp-2">
                    {story.title}
                  </h4>
                  {story.dek && (
                    <p className="text-[12px] text-[var(--wk-text-muted)] line-clamp-1">
                      {story.dek}
                    </p>
                  )}
