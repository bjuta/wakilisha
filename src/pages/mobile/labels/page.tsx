    ...
    <div className="wk-mobile-v5">
      ...
      {spotlight && (
        <div className="px-5 pb-4">
          <Link to={`/labels/${spotlight.slug}`} className="block rounded-[16px] border border-[var(--wk-border)] bg-[var(--wk-surface)] p-4">
      ...
      <div className="phn-scroll-row">
        {FEATURED_LABELS.map((label) => (
          <Link key={label.slug} to={`/labels/${label.slug}`} className="block w-[190px] shrink-0 rounded-[16px] border border-[var(--wk-border)] bg-[var(--wk-surface)] p-4">
