...
const VERTICAL = {
  key: "fashion",
  label: "Fashion",
  colorVar: "--wk-v-fashion",
  icon: "ri-t-shirt-line",
  description:
    "Designers, textiles, street style, fashion editorials, beauty, objects, visual identity, lookbooks, fashion events, and African aesthetic systems — documented and celebrated.",
};
      ...
      <section className="py-16 md:py-24" style={{ background: "var(--wk-bg-subtle)" }}>
        <div className="wk-container-wide px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-[900px] mx-auto">
            {[
              { title: "Designer Directory", desc: "Profiles of established and emerging African fashion designers and houses." },
              { title: "Street Style", desc: "Documenting everyday fashion as cultural expression across African cities." },
              { title: "Fashion Editorials", desc: "Original photography, lookbooks, and visual storytelling around African aesthetics." },
              { title: "Events & Shows", desc: "Fashion week coverage, runway shows, trunk shows, and pop-up markets." },
            ].map((item) => (
              <div
                key={item.title}
