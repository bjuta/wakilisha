  ...
  return (
    <main className="min-h-screen bg-[var(--wk-bg)]">
      ...
      <div ref={heroRef} className="relative min-h-[40vh] flex items-end overflow-hidden bg-[#0a0a0a] -mt-16">
        <img
          ref={heroImgRef}
          src="https://readdy.ai/api/search-image?query=Abstract%20editorial%20composition%20with%20warm%20olive%20green%20and%20charcoal%20layers%2C%20soft%20diffused%20light%2C%20contemporary%20gallery%20aesthetic%2C%20clean%20minimal%20structured%20overlaps%2C%20cinematic%20depth%2C%20editorial%20photography%20style%20with%20film%20grain%2C%20muted%20elegant%20legal%20document%20mood&width=1800&height=800&seq=terms-hero-2026-wk&orientation=landscape"
          alt=""
