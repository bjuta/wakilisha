  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <div className="wk-eyebrow mb-2">Chart Configuration</div>
          <h1 className="wk-h-page">Chart Families</h1>
        </div>
      ...
      <WkSurface className="p-8">
        <div className="text-center">
          <i className="ri-folder-chart-line mb-4 block text-4xl text-[var(--wk-text-faint)]" />
          <h2 className="text-[16px] font-bold text-[var(--wk-text)]">Chart Families</h2>
