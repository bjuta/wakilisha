...
const VERTICAL = {
  ...
  description:
    "Chefs, street food, recipes, regional food histories, food markets, supper clubs, culinary routes, diaspora food stories, and food as memory, place, and culture — preserved and shared.",
};
      ...
      <section className="py-16 md:py-24" style={{ background: "var(--wk-bg-subtle)" }}>
        <div className="wk-container-wide px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-[900px] mx-auto">
            {[
              { title: "Chef Profiles", desc: "Meet the chefs shaping African cuisine — from street vendors to fine dining visionaries." },
              { title: "Culinary Routes", desc: "Food-focused travel guides connecting cuisine, place, and cultural history." },
              { title: "Food Histories", desc: "Deep dives into regional food traditions, ingredients, and their cultural significance." },
              { title: "Supper Clubs & Markets", desc: "Curated listings of food experiences, pop-ups, and community food gatherings." },
            ].map((item) => (
              <div
                key={item.title}
              ...
              >
                <div
                  ...
                  style={{ background: `var(${VERTICAL.colorVar})`, color: "#fff" }}
                >
                  <i className="ri-bowl-line text-lg" />
                </div>
