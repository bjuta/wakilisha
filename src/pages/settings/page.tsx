    ...
    <main className="settings49-shell">
      <div className="settings49-wrap">
        <section className="settings49-hero">
          ...
          <p className="settings49-sub">Manage profile identity, appearance, notifications, privacy, playback, and account actions from one endpoint. Changes persist locally now and can be wired to authenticated user preferences later.</p>
        </section>
