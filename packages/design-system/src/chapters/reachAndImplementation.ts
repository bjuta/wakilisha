...
export const reachChapters: WkDesignChapterSpec[] = [
  {
    ...
    summary: 'Future content studio/export surfaces inherit tokens, typography, logo safe zones, and image rules. No safe-zone guides burned into output. Data-driven content blocks rather than manual one-off art. The design system is the source of truth for all exports.',
    ...
    tables: [],
    parityTargets: ['Keep content studio and public app design tokens unified.', 'Social templates are token-driven.'],
    qaChecks: [
  ...
  },
  {
    ...
    summary: 'Sponsors, partners, reports, and cultural products without making the app feel ad-stuffed. Commercial modules are clearly labeled and visually restrained. Editorial credibility is never compromised. Premium report/card surfaces are preferred over ad banners.',
    ...
    tables: [],
    parityTargets: ['Design sponsor/report modules that do not pollute charts or editorial.', 'Commercial surfaces are clearly labeled and non-intrusive.'],
    qaChecks: [
  ...
  },
  {
    ...
    summary: 'Music, Film, Fashion, Food, Language, Dance, Places, Intelligence, and Experiences share one chassis. Each vertical gets one accent and metadata vocabulary. Music components are generalized where possible for future verticals. No app fork.',
    ...
    tables: ['entity_slugs'],
    parityTargets: ['Add vertical token and surface metadata props to archetypes.', 'All archetypes support vertical prop.'],
    qaChecks: [
  ...
  },
  {
    ...
    summary: 'African languages and multi-locale data presentation. Locale-aware dates, numbers, currencies, and language spans. English-only is not assumed. Diacritics and source casing are preserved. Mixed-language content supports lang attributes.',
    ...
    tables: [],
    parityTargets: ['Use Intl and content lang metadata in page payloads.', 'All dates and numbers use locale-aware formatting.'],
    qaChecks: [
  ...
  },
  {
    ...
    summary: 'Source, credit, and provenance are visible enough to build trust. Images, tracks, charts, editorial, and playback sources carry attribution when available. Provider/source context is not removed from playback. Corrections and methodology links have consistent placement.',
    ...
    parityTargets: ['Add attribution modules to entity, chart, article, and player surfaces.', 'Attribution is visible on all content surfaces.'],
    qaChecks: [
...
export const implementationChapters: WkDesignChapterSpec[] = [
  {
    ...
    title: 'Tokens',
    summary: 'Bridge design tokens into CSS variables, Tailwind, React components, and theme mode. --wk-* variables are source of truth. Tailwind maps to tokens, not replaces them. Hard-coded spacing/colors are design debt unless part of media overlays or documented exceptions.',
    ...
    tables: [],
    parityTargets: ['Ship packages/design-system/src/wakilisha.tokens.css and import it app-wide.', 'All CSS uses --wk-* tokens.'],
    qaChecks: [
  ...
  },
  {
    ...
    summary: 'Components that all pages must use rather than rebuilding local variants. Components expose data-driven props and states. No duplicate Card/Button/Row/Hero per page. Every component has responsive and empty-state behavior. The admin bible shows component specimens.',
    ...
    tables: [],
    parityTargets: ['Create component backlog from chapters 10–54.', 'All pages use shared components, not one-off variants.'],
    qaChecks: [
  ...
  },
  {
    ...
    summary: 'Design work is organized around foundations, components, archetypes, and shipped pages. Figma frames mirror component inventory and page archetypes. Specimen pages map back to token/component names. No orphaned one-off frames without implementation status.',
    ...
    tables: [],
    parityTargets: ['Use the admin design bible as the in-app counterpart to Figma.', 'Admin bible mirrors Figma organization.'],
    qaChecks: [
  ...
  },
  {
    ...
    group: 'Implementation',
    title: 'QA Checklist',
    summary: 'Pass/fail system for design, accessibility, responsiveness, and data wiring. Every page must pass data, design, mobile, accessibility, copy, and performance checks. Screenshots are required before declaring parity. Mock data automatically fails production QA.',
    ...
    tables: [],
    parityTargets: ['Add page QA matrices to parity plan.', 'Every page has a documented QA checklist.'],
    qaChecks: [
  ...
  },
  {
    ...
    summary: 'Prevent AI-template design drift and generic React-app behavior. No fake data on public pages. No generic SaaS gradients, bouncy cards, emoji microcopy, or meaningless CTAs. No hard-coded content that should come from the repaired graph. No page ships without matching a design-system archetype.',
  ...
  },
  {
    ...
    group: 'Implementation',
    title: 'Roadmap',
    summary: 'Sequence design-system adoption: foundation first, then admin bible, then payloads, then public archetypes. Do not redesign all pages independently. Design parity is system compliance plus product behavior parity, not visual imitation.',
    ...
    tables: [],
    parityTargets: ['Use this roadmap to gate the React rebuild.', 'All phases are documented and tracked.'],
    qaChecks: [
