...
export const wakilishaDesignSystemSpec: WkDesignSystemSpec = {
  ...
  parityPageMap: [
    ...
    { route: '/charts', archetype: 'Charts index', chapters: ['21','35','39','15','16'], qaChecks: ['21-dense','21-canonical-links','21-no-fabricated','35-scale-appropriate','39-dense','39-playable','39-no-fabricated','15-density','15-playable','15-movement','16-dock-height','16-source-visible'] },
    { route: '/charts/:series/:edition', archetype: 'Charts edition', chapters: ['21','39','15','16','45'], qaChecks: ['21-dense','21-canonical-links','21-no-fabricated','39-dense','39-playable','39-no-fabricated','15-density','15-playable','15-movement','16-dock-height','16-source-visible','45-specific-copy','45-og-preview','45-timestamp'] },
    { route: '/artists', archetype: 'Artist directory', chapters: ['17','22','35','37','53'], qaChecks: ['17-entity-type','17-real-data','17-debounced','22-relationships-visible','22-graph-backed','22-slug-routes','35-scale-appropriate','37-culturally-important','37-grid-list','37-relationships','53-intentional','53-player-coexist','53-hit-area'] },
    { route: '/artists/:slug', archetype: 'Artist entity page', chapters: ['22','35','37','40','41','45'], qaChecks: ['22-relationships-visible','22-graph-backed','22-slug-routes','35-scale-appropriate','37-culturally-important','37-relationships','40-graph-backed','40-playback-enabled','40-attribution','41-tracklist-accurate','41-modal-consistent','41-no-flatten','45-specific-copy','45-og-preview','45-timestamp'] },
    { route: '/tracks/:slug', archetype: 'Single track', chapters: ['16','21','22','35','40','45'], qaChecks: ['16-dock-height','16-source-visible','16-no-fake','21-dense','21-canonical-links','21-no-fabricated','22-relationships-visible','22-graph-backed','22-slug-routes','35-scale-appropriate','40-graph-backed','40-playback-enabled','40-attribution','45-specific-copy','45-og-preview','45-timestamp'] },
    { route: '/releases', archetype: 'Release catalog', chapters: ['17','22','35','41','42'], qaChecks: ['17-entity-type','17-real-data','17-debounced','22-relationships-visible','22-graph-backed','22-slug-routes','35-scale-appropriate','41-tracklist-accurate','41-modal-consistent','41-no-flatten','42-focus-trap','42-reduced-motion','42-same-language'] },
    { route: '/releases/:slug', archetype: 'Single release', chapters: ['22','35','41','42','45'], qaChecks: ['22-relationships-visible','22-graph-backed','22-slug-routes','35-scale-appropriate','41-tracklist-accurate','41-modal-consistent','41-no-flatten','42-focus-trap','42-reduced-motion','42-same-language','45-specific-copy','45-og-preview','45-timestamp'] },
    { route: '/genres', archetype: 'Genre directory', chapters: ['17','22','35','36'], qaChecks: ['17-entity-type','17-real-data','17-debounced','22-relationships-visible','22-graph-backed','22-slug-routes','35-scale-appropriate','36-counts','36-no-stock','36-graph-backed'] },
    { route: '/genres/:slug', archetype: 'Genre page', chapters: ['22','35','36','37','40'], qaChecks: ['22-relationships-visible','22-graph-backed','22-slug-routes','35-scale-appropriate','36-counts','36-no-stock','36-graph-backed','37-culturally-important','37-grid-list','37-relationships','40-graph-backed','40-playback-enabled','40-attribution'] },
    { route: '/labels', archetype: 'Labels directory', chapters: ['17','22','35','43'], qaChecks: ['17-entity-type','17-real-data','17-debounced','22-relationships-visible','22-graph-backed','22-slug-routes','35-scale-appropriate','43-serious-registry','43-relationships','43-repaired'] },
    { route: '/labels/:slug', archetype: 'Label page', chapters: ['22','35','41','43'], qaChecks: ['22-relationships-visible','22-graph-backed','22-slug-routes','35-scale-appropriate','41-tracklist-accurate','41-modal-consistent','41-no-flatten','43-serious-registry','43-relationships','43-repaired'] },
    { route: '/magazine', archetype: 'Magazine index', chapters: ['20','35','38','44'], qaChecks: ['20-reading-width','20-related-routes','20-classified','35-scale-appropriate','38-editorial','38-classified','38-real-routes','44-reading-width','44-credible','44-related-graph'] },
    { route: '/magazine/:slug', archetype: 'Article page', chapters: ['20','35','44','45'], qaChecks: ['20-reading-width','20-related-routes','20-classified','35-scale-appropriate','44-reading-width','44-credible','44-related-graph','45-specific-copy','45-og-preview','45-timestamp'] },
    { route: '/admin/design-system', archetype: 'Living design bible', chapters: ['29','30','32','33','50'], qaChecks: ['29-token-source','29-no-hardcoded','29-theme-switch','30-reusable','30-data-driven','30-empty-state','32-data-pass','32-design-pass','32-mock-fails','33-no-fake','33-no-gradients','33-no-emojis','50-same-tokens','50-bible','50-not-backend'] },
  ],
